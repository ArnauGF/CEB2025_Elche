...
<div style="position:absolute; top:15%; left:30%; font-size:30px;">
...
<div style="position:absolute; top:80%; left:9%; font-size:30px;" class="fragment fade-in">
  $$\begin{split}
  (T_1 &,\delta_1) \\
  &w_1
  \end{split}$$
...
<div style="position:absolute; top:55%; left:33%; font-size:30px;">
  <img src="images/arrow.png" style="width:18%;" class="fragment fade-in">
</div>

<div style="position:absolute; top:80%; left:29%; font-size:30px;" class="fragment fade-in">
  $$\begin{split}
  (T_2 &,\delta_2) \\
  &w_2
  \end{split}$$
...
<div style="position:absolute; top:80%; left:79%; font-size:30px;" class="fragment fade-in">
  $$\begin{split}
  (T_n &,\delta_n) \\
  &w_n
  \end{split}$$
...
<div style="position:absolute; top:80%; left:7%; font-size:30px;" class="fragment fade-in">
  $$\tiny{\begin{split}
  (1.09 , & 1) \\
  (\text{female}, & \text{ D-peni} , 57)
  \end{split}}$$
</div>
